...
{
    public partial class ChangeFirstname : Form
    {
        public static string changedFirstname;
        public ChangeFirstname()
        {
            InitializeComponent();
        }

        private void ChangeFirstname_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                editRecord(Login.id1, Program.path, 1, Login.id1, us, textBox2.Text, ln, eml, psd, pop, Login.description, Login.joined);
                changedFirstname = textBox2.Text;
